...
let AddPurchasePage = () => {
  ...
  return (
    <div class="flex flex-col space-y-5 w-full h-full p-5 rounded-t shadow bg-white dark:bg-gray-900 select-none">
      ...
      <div class="flex flex-col md:flex-row w-full h-full space-y-5 space-x-0 md:space-x-5 md:space-y-0 overflow-y-auto">
              ...
              <div class="w-full h-full overflow-y-auto">
                <table class="table-auto w-full">
                  <thead class="border-b border-gray-200 dark:border-gray-800">
                    <tr>
                      <th class="p-3 text-left">Full Name {searchUser()}</th>
